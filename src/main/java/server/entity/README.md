...
## Class Details
- `User`: Represents the `"user"` table (quoted to avoid conflicts with reserved SQL keywords). Stores firstName, lastName, unique email, passwordHash, and createdAt. The root owner of all domain resources.
